...
//
//		JFrame selection=new JFrame();		//frame for selection
//        String[]yesNo=new String[2];        //array for yes/no
//		String[]oddsEvens=new String[2];	//array for odds/evens
//		int playerSel;					    //player selection
//		int playerFingers=0;				//player fingers
//        int computerFingers=0;              //computer fingers
//		int playerScore=0;					//player score
//		int computerScore=0;				//computer score
//		int another;						//play another game?
//        boolean valid=false;                //error catching loop variable
//
//        yesNo[0]="Yes";
//        yesNo[1]="No";
//
...
//            Morra myMorra=new Morra(playerSel);	//create new instance of Morra with player selection
//
